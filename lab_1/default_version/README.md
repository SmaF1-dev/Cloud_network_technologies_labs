...
7) Добавить самоподписанный сертификат и работу с https
...
### Танцы с б̶у̶б̶н̶а̶м̶и сертификатами
...
![img_3.png](images/generate_cert.png)
...
![img.png](images/no_443_port.png)
...
[img_1.png](images/add_cert.png)
![img_2.png](images/add_cert_2.png)
![img_4.png](images/added_cert.png)

И спустя несколько томных дней ура, победа, наконец-то наши сайты работают и браузер не ругается!
